...
def main(trucksc, val_list, indice, truckscenesyaml, args, config):
    ...
    for i, group in enumerate(groups):
        ...
        ego_motion_cabin_i = trucksc.getclosest('ego_motion_cabin', sample['timestamp'])
        ego_motion_chassis_i = trucksc.getclosest('ego_motion_chassis', sample['timestamp'])
        ...
        frame_dict = {
            ...
            "ego_motion_cabin": ego_motion_cabin_i,
            "ego_motion_chassis": ego_motion_chassis_i,
