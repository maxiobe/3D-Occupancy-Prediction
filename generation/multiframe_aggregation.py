...
def main(trucksc, val_list, indice, truckscenesyaml, args, config):
    ...
    while True:
        ...
        elif load_mode == 'rigit':
            sensor_fused_pc = get_rigit_fused_pointcloud(trucksc, my_sample)
        else:
    ...
    while int(i) < 10000:  # Assuming the sequence does not have more than 10000 frames to avoid infinite loops
        ...
        ####################################################################################
        print(dense_voxels_with_semantic.shape)
...
if __name__ == '__main__':
    ...
    parse.add_argument('--load_mode', type=str, default='pointwise')
